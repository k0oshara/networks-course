...
Реализация рассчитана на передачу одного файла от одного клиента к одному серверу за один запуск.
Поддержка нескольких одновременных клиентов в условии пункта A не было.
